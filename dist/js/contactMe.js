...
(function () {
    ...
    var controller = {
        ...
        bindEvents: function bindEvents() {
            view.find('#contact-me').on('click', function (event) {
                EventsHub.publish('contact', $(event.currentTarget).attr('data-bind-page'));
            });
        }
    };

...
(function () {
    ...
    var model = {
        ...
        generateTemporaryTemplate: function generateTemporaryTemplate(temporaryTemplate, data, indexString) {
        ...
        showLeanCloudData: function showLeanCloudData() {
            ...
            this.data.map(function (song, index) {
                _this3.temporaryTemplate.push(_this3.generateTemporaryTemplate(_this3.template, song, index + 1 + ''));
            });
    ...
    var controller = {
        ...
        bindEvents: function bindEvents() {
            ...
            EventsHub.subscribe('nextMusic', function (id) {
                var nextMusic = void 0;

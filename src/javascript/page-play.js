    ...
    let controller = {
        ...
        pauseAndPlay() {
            view.el.on('click', '.play-pause-btn', () => {
                ...
                this.data.isPlaying ? view.find('audio')[0].pause() : view.find('audio')[0].play();
